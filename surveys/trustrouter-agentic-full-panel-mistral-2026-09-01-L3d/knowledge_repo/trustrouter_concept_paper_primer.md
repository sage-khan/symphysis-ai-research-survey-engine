...
This is a plain-English summary of the TrustRouter concept paper's actual
...
round), both from the author's broader TrustRouter research. The
constraint-gate description is from the TrustRouter construction research
paper (`trustrouter_construction_researchpaper.tex`).
