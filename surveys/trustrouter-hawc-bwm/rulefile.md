# Survey rules: TrustRouter Full Hierarchy Weight Elicitation

This survey elicits Best-Worst Method weights across the complete real
TrustRouter framework, not a subset of it: seven separate comparison
levels covering the top-level composite
...
2. **The real survey file**
   (`trustrouter_expert_questionnaire_v5_real_survey_instrument.md`): the
   complete TrustRouter Expert Questionnaire (v5, May 2026, Universidad de
   Granada / University of Ljubljana) as it was actually administered to the real
