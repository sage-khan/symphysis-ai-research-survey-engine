# Survey rules: TrustRouter SLM Panel Run 1 -- Level L3b (Provenance Trust sub-parts)
...
The three sub-parts that decompose Provenance Trust (PT) from L2: source credentials, custody chain, and historical track record.
