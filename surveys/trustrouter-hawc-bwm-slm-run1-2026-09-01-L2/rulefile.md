# Survey rules: TrustRouter SLM Panel Run 1 -- Level L2 (Six trust dimensions inside DVS)
...
The six trust dimensions that make up the Data Value Score (DVS) factor from L1. These six weights, once aggregated, determine how DVS itself is computed as a weighted combination of Quality, Provenance Trust, Verification Strength, Independent Confirmation, Legal Compliance, and Criticality.
