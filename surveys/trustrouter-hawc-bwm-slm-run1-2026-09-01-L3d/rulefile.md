# Survey rules: TrustRouter SLM Panel Run 1 -- Level L3d (Attack Resistance sub-parts)
...
The three sub-parts that decompose Attack Resistance (A) from L1: Sybil resistance, oracle resistance, and insider resistance.
