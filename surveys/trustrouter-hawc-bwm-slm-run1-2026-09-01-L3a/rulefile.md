# Survey rules: TrustRouter SLM Panel Run 1 -- Level L3a (Quality clusters (ISO 25012))
...
The three ISO 25012 quality clusters that decompose Quality (Q) from L2 into Intrinsic, Contextual, and Representational quality.
