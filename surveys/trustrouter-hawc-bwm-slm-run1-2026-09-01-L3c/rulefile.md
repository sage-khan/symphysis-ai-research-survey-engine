# Survey rules: TrustRouter SLM Panel Run 1 -- Level L3c (Verification Strength sub-parts)
...
The three sub-parts that decompose Verification Strength (V) from L2: cryptographic evidence, audit-trail completeness, and diversity of verification sources.
